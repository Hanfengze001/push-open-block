 ...
 */
Me7SegmentDisplay::Me7SegmentDisplay(int dataPin, int clkPin)
{
  _dataPin = dataPin;
  _clkPin = clkPin;
...
void Me7SegmentDisplay::displaytime(int DispData1, int DispData2)
{
	int shiwei1 = int(DispData1/10);
	int gewei1 = int(DispData1%10);
	int shiwei2 = int(DispData2/10);
	int gewei2 = int(DispData2%10);
	//Serial.println(gewei1);
	//if(DispData1 < 10)
	write(0,pgm_read_byte(&TubeTab[shiwei1]));
	write(1,pgm_read_byte(&TubeTab[gewei1])+0x80);
	write(2,pgm_read_byte(&TubeTab[shiwei2]));
	write(3,pgm_read_byte(&TubeTab[gewei2]));
